# LNTH — Dead Simple Research card package

One folder = one ticker. Everything shareable for LNTH lives here, and every
...
Copy this whole folder into the site repo at `public/cards/LNTH/`, then:
...
Status: Pass | Dead Simple Score: 81/100 | Schema v1
