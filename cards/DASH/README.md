# DASH — Dead Simple Research card package

One folder = one ticker. Everything shareable for DASH lives here, and every
...
Copy this whole folder into the site repo at `public/cards/DASH/`, then:
...
re-run `python make_media.py 20260616_234409` and re-upload this folder.

When the position is closed (`python card_lifecycle.py close DASH`), the
