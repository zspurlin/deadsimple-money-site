# NFLX — Dead Simple Research card package

One folder = one ticker. Everything shareable for NFLX lives here, and every
...
Copy this whole folder into the site repo at `public/cards/NFLX/`, then:
...
re-run `python make_media.py 20260618_150502` and re-upload this folder.
