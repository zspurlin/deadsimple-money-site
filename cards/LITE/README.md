# LITE — Dead Simple Research card package

One folder = one ticker. Everything shareable for LITE lives here, and every
...
Copy this whole folder into the site repo at `public/cards/LITE/`, then:
...
re-run `python make_media.py 20260618_122502` and re-upload this folder.

When the position is closed (`python card_lifecycle.py close LITE`), the
