# TOST — Dead Simple Research card package

One folder = one ticker. Everything shareable for TOST lives here, and every
...
Copy this whole folder into the site repo at `public/cards/TOST/`, then:
...
re-run `python make_media.py 20260620_122852` and re-upload this folder.

When the position is closed (`python card_lifecycle.py close TOST`), the
