# AXON — Dead Simple Research card package

One folder = one ticker. Everything shareable for AXON lives here, and every
...
Copy this whole folder into the site repo at `public/cards/AXON/`, then:
...
re-run `python make_media.py 20260610_194143` and re-upload this folder.
